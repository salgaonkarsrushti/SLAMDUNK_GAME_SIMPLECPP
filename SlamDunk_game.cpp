...
if(((x>=490 && x<=510) && (y>=285 && y<=304))|| ((x1>=490 && x1<=510) && (y1>=285 && y1<=304))){
//closeCanvas();
wait(1);
//initCanvas("Character",1000,1000);
//initCanvas("Character",1000,1000);
int x;
int y;
int score=0;
...
if(score<=2)
{
/*Rectangle go(450,450,510,510);
go.setColor(COLOR(0,0,255));
go.setFill(COLOR(0,0,255));
Text(500,500," GAME   OVER");
wait(15);*/
}
